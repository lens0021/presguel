...
- [x] 설정창(GTK4/libadwaita, 즉시 적용) + 간단 모드(한글/영문 항목 직접 지정)
...
- 그래서 presguel 은 **키보드 배열별 엔진을 여러 개 등록**합니다:
  `Presguel`(QWERTY), `Presguel (Dvorak)`, `Presguel (Colemak)`, `Presguel (Workman)` 등
